        ...
        try (JNIConfigSource source = new JNIConfigSource(loader)) {
            ...
            for (String line : source.lines) {
                ...
                if (clazz == null) {
                    ...
                    registry.register(predicate, clazz);
                    registry.register(predicate, Array.newInstance(clazz, 0).getClass());
                ...
                switch (tokens[0]) {
                    case "field": {
                        ...
                        try {
                            registry.register(predicate, false, clazz.getDeclaredField(fieldName));
                    ...
                    case "method": {
                        ...
                        try {
                            if ("<init>".equals(methodName)) {
                                ...
                                registry.register(predicate, cons);
                                ...
                                registry.register(predicate, clazz.getDeclaredMethod(methodName, parameters));
                            }
