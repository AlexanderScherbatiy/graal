...
public final class ReflectionFeature implements GraalFeature {
    ...
    public void duringSetup(DuringSetupAccess a) {
        ...
        ReflectionConfigurationParser<PredicatedElement<Class<?>>> parser = ConfigurationParserUtils.create(reflectionData, access.getImageClassLoader());
    ...
    public void beforeAnalysis(BeforeAnalysisAccess access) {
        ...
        reflectionData.flushPredicatedConfiguration(access);
    }
