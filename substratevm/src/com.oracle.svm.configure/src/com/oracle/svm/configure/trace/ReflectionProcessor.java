...
class ReflectionProcessor extends AbstractProcessor {
    ...
    public void processEntry(Map<String, ?> entry) {
        ...
        if (isLoadClass || function.equals("forName") || function.equals("findClass")) {
            ...
            if (!advisor.shouldIgnore(lazyValue(name), lazyValue(callerClass)) &&
                ...
                configuration.getOrCreateType(predicate, name);
            }
            return;
            ...
            for (String type : typeNames) {
                if (!advisor.shouldIgnore(lazyValue(type), lazyValue(callerClass))) {
                    configuration.getOrCreateType(predicate, type);
                }
            }
        }
        ...
        switch (function) {
            case "getDeclaredFields": {
                configuration.getOrCreateType(predicate, clazz).setAllDeclaredFields();
                break;
            }
            case "getFields": {
                configuration.getOrCreateType(predicate, clazz).setAllPublicFields();
                break;
            }

            case "getDeclaredMethods": {
                configuration.getOrCreateType(predicate, clazz).setAllDeclaredMethods();
                break;
            }
            case "asInterfaceInstance":
            case "getMethods": {
                configuration.getOrCreateType(predicate, clazz).setAllPublicMethods();
                break;
            }

            case "getDeclaredConstructors": {
                configuration.getOrCreateType(predicate, clazz).setAllDeclaredConstructors();
                break;
            }
            case "getConstructors": {
                configuration.getOrCreateType(predicate, clazz).setAllPublicConstructors();
                break;
            }

            case "getDeclaredClasses": {
                configuration.getOrCreateType(predicate, clazz).setAllDeclaredClasses();
                break;
            }
            case "getClasses": {
                configuration.getOrCreateType(predicate, clazz).setAllPublicClasses();
                break;
            }
            ...
            case "getDeclaredField":
                ...
                // fall through
            case "getField": {
                configuration.getOrCreateType(predicate, clazzOrDeclaringClass).addField(singleElement(args), memberKind, false);
                if (!clazzOrDeclaringClass.equals(clazz)) {
                    configuration.getOrCreateType(predicate, clazz);
                }
                break;
            }
            ...
            case "getMethod": {
                ...
                configuration.getOrCreateType(predicate, clazzOrDeclaringClass).addMethod(name, SignatureUtil.toInternalSignature(parameterTypes), memberKind);
                if (!clazzOrDeclaringClass.equals(clazz)) {
                    configuration.getOrCreateType(predicate, clazz);
                }
                break;
            ...
            case "getConstructor": {
                ...
                configuration.getOrCreateType(predicate, clazzOrDeclaringClass).addMethod(ConfigurationMethod.CONSTRUCTOR_NAME, signature, memberKind);
                break;
            }
            ...
            case "newInstance": {
                if (clazz.equals("java.lang.reflect.Array")) { // reflective array instantiation
                    configuration.getOrCreateType(predicate, (String) args.get(0));
                } else {
                    configuration.getOrCreateType(predicate, clazz).addMethod(ConfigurationMethod.CONSTRUCTOR_NAME, "()V", ConfigurationMemberKind.DECLARED);
                }
                break;
            }
    ...
    private void addFullyQualifiedDeclaredMethod(String descriptor) {
        ...
        configuration.getOrCreateType(ConfigurationPredicate.objectPredicate(), qualifiedClass).addMethod(methodName, signature, ConfigurationMemberKind.DECLARED);
    }
