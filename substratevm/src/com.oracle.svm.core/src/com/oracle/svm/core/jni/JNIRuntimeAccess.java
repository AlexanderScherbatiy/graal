...
public final class JNIRuntimeAccess {
    ...
    public static void register(Class<?>... classes) {
        getSupport().register(ConfigurationPredicate.objectPredicate(), classes);
    }

    public static void register(Executable... methods) {
        getSupport().register(ConfigurationPredicate.objectPredicate(), methods);
    }
    ...
    public static void register(boolean finalIsWritable, Field... fields) {
        getSupport().register(ConfigurationPredicate.objectPredicate(), finalIsWritable, fields);
    }
